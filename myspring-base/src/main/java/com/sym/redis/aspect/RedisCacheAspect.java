package com.sym.redis.aspect;

import com.sym.redis.FastJsonUtil;
import com.sym.redis.annotation.RedisCache;
import com.sym.redis.annotation.RedisEvit;
...
public class RedisCacheAspect {
     ...
     * 并且用于内建属性为查询的方法之上
     */
    @Pointcut("@annotation(com.sym.redis.annotation.RedisCache)")
     ...
     */
    @Pointcut("@annotation(com.sym.redis.annotation.RedisEvit)")
